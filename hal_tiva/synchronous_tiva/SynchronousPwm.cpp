...
namespace hal::tiva
{
    namespace
    {
        ...
        constexpr uint32_t ToRccPwmDiv(uint32_t multiplyFactor)
        {
            ...
            {
                case 2:
                    return SYSCTL_RCC_PWMDIV_2;
                    break;
                case 4:
                    return SYSCTL_RCC_PWMDIV_4;
                    break;
                case 8:
                    return SYSCTL_RCC_PWMDIV_8;
                    break;
                case 16:
                    return SYSCTL_RCC_PWMDIV_16;
                    break;
                case 32:
                    return SYSCTL_RCC_PWMDIV_32;
                    break;
                case 64:
                    return SYSCTL_RCC_PWMDIV_64;
                    break;
                default:
                    std::abort();
            }
        ...
        constexpr uint32_t ToCcPwmDiv(uint32_t multiplyFactor)
        {
            ...
            {
                case 2:
                    return PWM_CC_PWMDIV_2;
                    break;
                case 4:
                    return PWM_CC_PWMDIV_4;
                    break;
                case 8:
                    return PWM_CC_PWMDIV_8;
                    break;
                case 16:
                    return PWM_CC_PWMDIV_16;
                    break;
                case 32:
                    return PWM_CC_PWMDIV_32;
                    break;
                case 64:
                    return PWM_CC_PWMDIV_64;
                    break;
                default:
                    std::abort();
            }
