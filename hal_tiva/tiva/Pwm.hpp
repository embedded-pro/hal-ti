...
namespace hal::tiva
{
    ...
    public:
        ...
        void Start(hal::DutyCycle globalDutyCycle) override;
        void Start(hal::DutyCycle dutyCycle1, hal::DutyCycle dutyCycle2) override;
        void Start(hal::DutyCycle dutyCycle1, hal::DutyCycle dutyCycle2, hal::DutyCycle dutyCycle3) override;
        void Start(hal::DutyCycle dutyCycle1, hal::DutyCycle dutyCycle2, hal::DutyCycle dutyCycle3, hal::DutyCycle dutyCycle4) override;
        void Stop() override;
