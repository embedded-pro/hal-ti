...
void Adc0Sequence0_Handler() __attribute__((weak, alias("Default_Handler")));
void Adc0Sequence1_Handler() __attribute__((weak, alias("Default_Handler")));
void Adc0Sequence2_Handler() __attribute__((weak, alias("Default_Handler")));
void Adc0Sequence3_Handler() __attribute__((weak, alias("Default_Handler")));
...
__attribute__((section(".isr_vector"))) void (*const g_pfnVectors[])(void) = {
    ...
    Adc0Sequence2_Handler, /*!< ADC0SS2_Handler,           ADC Sequence 2 */
    Adc0Sequence3_Handler, /*!< ADC0SS3_Handler,           ADC Sequence 3 */
    WatchDog_Handler,      /*!< WatchDog_Handler,          Watchdog timer */
