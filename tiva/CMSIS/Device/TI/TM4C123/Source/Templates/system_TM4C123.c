...
//
#define RCC_Val                                                                                                                           \
   (((CFG_RCC_SYSDIV - 1) << 23) | (CFG_RCC_USESYSDIV << 22) | (CFG_RCC_USEPWMDIV << 20) | (CFG_RCC_PWMDIV << 17) | (CFG_RCC_PWRDN << 13) \
       | (CFG_RCC_BYPASS << 11) | (CFG_RCC_XTAL << 6) | (CFG_RCC_OSCSRC << 4) | (CFG_RCC_IOSCDIS << 1) | (CFG_RCC_MOSCDIS << 1))

#define RCC2_Val                                                                                                                 \
   ((CFG_RCC2_USERCC2 << 31) | ((CFG_RCC_SYSDIV2 - 1) << 23) | (CFG_RCC_PWRDN2 << 13) | (CFG_RCC_BYPASS2 << 11) | (CFG_RCC_OSCSRC2 << 4))
...
__INLINE static uint32_t getOscClk(uint32_t xtal, uint32_t oscSrc)
{
   ...
   { /* switch OSCSRC */
      case 0: /* MOSC Main oscillator */
         switch (xtal)
         { /* switch XTAL */
            case 0x0: oscClk = 1000000UL; break;
            case 0x1: oscClk = 1843200UL; break;
            case 0x2: oscClk = 2000000UL; break;
            case 0x3: oscClk = 2457600UL; break;
            case 0x4: oscClk = 3579545UL; break;
            case 0x5: oscClk = 3686400UL; break;
            case 0x6: oscClk = 4000000UL; break;
            case 0x7: oscClk = 4096000UL; break;
            case 0x8: oscClk = 4915200UL; break;
            case 0x9: oscClk = 5000000UL; break;
            case 0xA: oscClk = 5120000UL; break;
            case 0xB: oscClk = 6000000UL; break;
            case 0xC: oscClk = 6144000UL; break;
            case 0xD: oscClk = 7372800UL; break;
            case 0xE: oscClk = 8000000UL; break;
            case 0xF: oscClk = 8192000UL; break;
            case 0x10: oscClk = 10000000UL; break;
            case 0x11: oscClk = 12000000UL; break;
            case 0x12: oscClk = 12288000UL; break;
            case 0x13: oscClk = 13560000UL; break;
            case 0x14: oscClk = 14318180UL; break;
            case 0x15: oscClk = 16000000UL; break;
            case 0x16: oscClk = 16384000UL; break;
            default: break;
         }
         break;
      case 1: /* IOSC Internal oscillator */ oscClk = XTALI; break;
      case 2: /* IOSC/4 Internal oscillator/4 */ oscClk = XTALI / 4; break;
      case 3: /* 30kHz internal oscillator  */ oscClk = XTAL30K; break;
      default: break;
   }
